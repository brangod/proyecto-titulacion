<div class="bg-slate-800 bg-opacity-50 flex justify-center items-center absolute top-0 right-0 bottom-0 left-0">
    <div class="bg-white px-16 py-14 rounded-md">
        <h1 class="text-xl mb-4 font-bold text-slate-500">Seguro desea aceptar esta solicitud?</h1>
        <form>
        ...
        <button wire:click.prevent='aceptar()' class="bg-green-500 px-7 py-2 ml-2 rounded-md text-md text-white font-semibold">Aceptar</button>
        </form>
    </div>
</div>