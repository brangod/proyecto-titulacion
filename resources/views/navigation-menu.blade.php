<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="flex items-center shrink-0">
                    <a href="{{ route('dashboard.inicio') }}">
                        <img src="{{ asset('img/multimetro.png') }}" class="w-14 h-14" alt="error">
                    </a>
                </div>

                <!-- Navigation Links -->
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <x-jet-nav-link href="{{ route('dashboard.inicio') }}" :active="request()->routeIs('dashboard.inicio')">
                        {{ __('Inicio') }}
                    </x-jet-nav-link>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            <x-jet-responsive-nav-link href="{{ route('dashboard.inicio') }}" :active="request()->routeIs('dashboard.inicio')">
                {{ __('Dashboard') }}
