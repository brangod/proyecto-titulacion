            ...
            <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="container flex flex-col flex-wrap items-center px-5 mx-auto md:flex-row">
                    ...
                    <nav
                        ...
                        <a href="{{route('dashboard.inicio')}}" class="mr-5 hover:text-gray-900">Inicio</a>
                        <a href="{{route('dashboard.solicitudes')}}" class="mr-5 hover:text-gray-900">Solicitudes </a>
                        <a href="{{route('dashboard.historial')}}" class="mr-5 hover:text-gray-900">Historial</a>
                        {{-- <a href="{{route('dashboard.practicas')}}" class="mr-5 hover:text-gray-900">Practicas</a> --}}
                    </nav>
