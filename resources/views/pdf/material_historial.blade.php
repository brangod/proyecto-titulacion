...
<body>
    <h1 class="font-bold text-lg">Historial Material: {{$m->nombre}}</h1>
                    ...
                    <table class="min-w-full leading-normal">
                        <thead>
                            <tr>
                                ...
                                <th class="px-5 py-3 border-b-2 border-sky-200 bg-blue-100 text-center text-xs font-semibold text-gray-600 uppercase">Usuario Prestado</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="px-5 py-5 border-b border-sky-200 bg-blue-100 text-sm">{{$h->user->name}}</td>
